    ...
    try {
        ...
        if (latestData.rows.length === 0) {
            ...
            prompt = `You are a smart flood detection bot. Start by greeting the user and stating that you're here to provide immediate flood detection guidance.
                        ...
                        3. If the current water level (${latestwaterLevelDataString}) is 80% and above:
        ...
        const response = await axios.post(
            ...
            //`${azureEndpoint}/openai/deployments/gpt-4o/chat/completions?api-version=2023-03-15-preview`,
            requestBody,
            { headers }
        );
